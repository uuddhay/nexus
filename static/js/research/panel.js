...
const _RESEARCH_HINTS = [
  "e.g. Trace Nexus's ten-year journey home from Troy — every island, monster, and detour, and why each one cost him",
...
const _SETTINGS_KEY = 'nexus-research-settings';
const _COLLAPSE_KEY = 'nexus-research-settings-collapsed';
...
function _wireEvents(pane) {
  ...
  pane.querySelector('#research-settings-toggle').addEventListener('click', () => {
    ...
    try { localStorage.setItem('nexus-research-settings-collapsed', _settingsCollapsed ? '1' : '0'); } catch {}
  });
