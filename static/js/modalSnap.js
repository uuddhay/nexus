...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'nexus-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'nexus-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('nexus:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
