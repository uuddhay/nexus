...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'nexus-model-expanded',
  MODEL_ENDPOINTS: 'nexus-model-endpoints',
  MODEL_SELECTED: 'nexus-selected-model',
  SORT_ORDER: 'nexus-sessions-sort',
  CHAT_SEARCH_SCOPE: 'nexus-search-scope',
  INCOGNITO: 'nexus-incognito',
  RAG_ACTIVE: 'nexus-rag-active',
  MCP_ACTIVE: 'nexus-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'nexus-density',
  UI_SCALE: 'nexus-ui-scale',
