...
let _searchQuery = '';
let _viewMode = (typeof localStorage !== 'undefined' && localStorage.getItem('nexus-notes-view')) || 'list'; // 'list' or 'grid'
...
const REMINDER_FIRED_KEY = 'nexus-notes-reminder-fired';
...
const REMINDER_GLOWED_KEY = 'nexus-notes-reminder-glowed';
...
const REMINDER_PENDING_HIGHLIGHT_KEY = 'nexus-notes-reminder-pending-highlight';
const REMINDER_ACTIVE_HIGHLIGHT_KEY = 'nexus-notes-reminder-active-highlight';
...
const REMINDER_DISMISSED_AT_KEY = 'nexus-notes-reminder-dismissed-at';
const NOTES_FIRST_OPEN_HINT_KEY = 'nexus-notes-first-open-hint-v1';
...
function _bringNotesToFront(pane = document.getElementById('notes-pane')) {
  ...
  try {
    window.dispatchEvent(new CustomEvent('nexus:modal-opened', {
...
export function openPanel() {
  ...
  if (viewBtn) {
    ...
    viewBtn.addEventListener('click', () => {
      ...
      try { localStorage.setItem('nexus-notes-view', _viewMode); } catch {}
      pane.classList.toggle('notes-view-grid', _viewMode === 'grid');
      _setViewLabel();
      requestAnimationFrame(() => _applyMasonry(document.querySelector('#notes-pane .notes-pane-body')));
    });
...
const _DRAFT_PREFIX = 'nexus-note-draft-';
