"""`nexus-research list --status complete` was returning nothing.
...
Part of #2122 (nexus-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "nexus-research"
    loader = importlib.machinery.SourceFileLoader("nexus_research_cli", str(path))
