...
```text
[order-report] working directory: /path/to/nexus
...
[order-report] reproduce with: /path/to/nexus/venv/bin/python /path/to/nexus/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
