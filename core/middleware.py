...
INTERNAL_TOOL_TOKEN = os.environ.get("NEXUS_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Nexus-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Nexus-Internal-Token), or
