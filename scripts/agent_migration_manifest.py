...
This helper is intentionally read-only. It does not import the Nexus
application package, write to data/, call an LLM, or apply anything. It turns
common agent export shapes into a portable JSON manifest that Nexus can
...
def parse_args(argv: list[str] | None = None):
    parser = argparse.ArgumentParser(description="Build a neutral Nexus agent migration manifest.")
