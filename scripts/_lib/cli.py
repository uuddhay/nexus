"""scripts/_lib/cli.py — shared scaffolding for the `nexus-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("nexus-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/nexus-foo`
...
VERSION = "0.1.0"  # bumped centrally; every nexus-* CLI reports this
