...
COPILOT_USER_AGENT = os.environ.get(
    "NEXUS_COPILOT_USER_AGENT", "Nexus/1.0"
)
COPILOT_INTEGRATION_ID = os.environ.get(
    "NEXUS_COPILOT_INTEGRATION_ID", "vscode-chat"
)
COPILOT_EDITOR_VERSION = os.environ.get(
    "NEXUS_COPILOT_EDITOR_VERSION", "Nexus/1.0"
)
