...
Imports MemoryManager and MemoryVectorStore from the Nexus codebase.
"""
...
_OWNER_ENV_KEYS = ("NEXUS_MCP_MEMORY_OWNER", "NEXUS_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set NEXUS_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
