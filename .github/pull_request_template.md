...
- [ ] I searched [open issues](https://github.com/uuddhay/nexus/issues) and [open PRs](https://github.com/uuddhay/nexus/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Nexus's existing visual language. Specifically:
